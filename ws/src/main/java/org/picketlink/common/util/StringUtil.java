...
public class StringUtil {
    ...
    public static String getSystemPropertyAsString(String str) {
        if (str == null)
            ...
            //rls throw logger.nullArgumentError("str");
        if (str.contains("${")) {
            ...
            while (matcher.find()) {
                ...
                if (sysPropertyValue.isEmpty()) {
                    throw new RuntimeException(ErrorCodes.SYSTEM_PROPERTY_MISSING + matcher.group(1));
                    //rls throw logger.systemPropertyMissingError(matcher.group(1));
                }else{
    ...
    public static void match(String first, String second) {
        if (first.equals(second) == false)
            ...
            //rls throw logger.notEqualError(first, second);
    }
