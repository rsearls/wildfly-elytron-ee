...
public class TransformerUtil {
    ...
    private static final Logger logger = Logger.getLogger(TransformerUtil.class.getName());
     ...
     */
    public static Transformer getTransformer() throws GeneralSecurityException {
    ...
    public static TransformerFactory getTransformerFactory() throws TransformerFactoryConfigurationError {
        if (transformerFactory == null) {
            ...
            //rls boolean tccl_jaxp = SystemPropertiesUtil.getSystemProperty(GeneralConstants.TCCL_JAXP, "false").equalsIgnoreCase("true");
...
**/
     ...
     * @throws GeneralSecurityException
     */
    public static void transform(Transformer transformer, Source source, DOMResult result) throws GeneralSecurityException {
        String TCCL_JAXP = "picketlink.jaxp.tccl";
        //rls boolean tccl_jaxp = SystemPropertiesUtil.getSystemProperty(GeneralConstants.TCCL_JAXP, "false").equalsIgnoreCase("true");
        boolean tccl_jaxp = SecurityActions.getSystemProperty(TCCL_JAXP, "false").equalsIgnoreCase("true");
    ...
    private static class PicketLinkStaxToDOMTransformer extends Transformer {
        ...
        public void transform(Source xmlSource, Result outputTarget) throws TransformerException {
            if (!(xmlSource instanceof StAXSource))
                ...
                //rls throw logger.wrongTypeError("xmlSource should be a stax source");
            if (outputTarget instanceof DOMResult == false)
                ...
                //rls throw logger.wrongTypeError("outputTarget should be a dom result");
            ...
            if (xmlEventReader == null)
                throw  new TransformerException(new RuntimeException(ErrorCodes.NULL_VALUE + "XMLEventReader"));
                //rls throw new TransformerException(logger.nullValueError("XMLEventReader"));
        ...
        private Element handleStartElement(XMLEventReader xmlEventReader, StartElement startElement, CustomHolder holder)
            ...
            while (attrs != null && attrs.hasNext()) {
                ...
                //rls if (logger.isTraceEnabled()) {
                    logger.log(Level.INFO, "Creating an Attribute Namespace=" + ns + ":" + qual);
                    //rls logger.trace("Creating an Attribute Namespace=" + ns + ":" + qual);
                //rls }
            ...
            while (namespaces != null && namespaces.hasNext()) {
                ...
                if (qual.equals("xmlns"))
                    continue;
                //rls if (logger.isTraceEnabled()) {
                    //rls logger.trace("Set Attribute Namespace=" + name.getNamespaceURI() + "::Qual=:" + qual + "::Value="
                    logger.log(Level.INFO, "Set Attribute Namespace=" + name.getNamespaceURI() + "::Qual=:" + qual + "::Value="
            ...
            if (nextEvent instanceof Comment) {
                ...
                if (trimmedData != null && trimmedData.length() > 0) {
                    ...
                    try {
                        ...
                        throw new GeneralSecurityException(e);
                        //rls throw logger.parserException(e);
                    }
                }
            }
            return el;
