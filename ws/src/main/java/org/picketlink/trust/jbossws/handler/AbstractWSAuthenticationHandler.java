...
//rls import org.picketlink.common.exceptions.ConfigurationException;
...
public abstract class AbstractWSAuthenticationHandler extends AbstractPicketLinkTrustHandler {
    private static final Logger logger = Logger.getLogger(AbstractWSAuthenticationHandler.class.getName());

    /* (non-Javadoc)
     * @see org.picketlink.trust.jbossws.handler.AbstractPicketLinkTrustHandler#handleInbound(jakarta.xml.ws.handler.MessageContext)
     */
    @Override
    protected boolean handleInbound(MessageContext msgContext) {

        logger.log(Level.FINE, "Handling Inbound Message");
        ...
        try {
            ...
            logger.log(Level.SEVERE, "Error loading the AuthenticationManager.", e);
        ...
        logger.log(Level.FINE, "Successfully Authenticated:Principal = " + principal + "  ::subject = " + subject);
     ...
     */
    protected AuthenticationManager getAuthenticationManager(MessageContext msgContext) throws GeneralSecurityException {
